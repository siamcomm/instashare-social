...
Yes. The code can be downloaded or cloned from the [InstaShare Social](https://github.com/siamcomm/instashare-social) Git Hub repository.
If you are a programmer, feel free to clone the repository or make changes to the public repo.
